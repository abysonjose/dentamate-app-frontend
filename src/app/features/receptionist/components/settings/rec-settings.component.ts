...
@Component({
  selector: 'app-rec-settings',
  templateUrl: './rec-settings.component.html',
  styleUrls: ['./rec-settings.component.scss'],
  animations: [
    trigger('tabContent', [
      transition(':enter', [
...
export class RecSettingsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  sessions: Session[] = [
    { id: 's1', device: 'Chrome · Windows 11', location: 'Lagos, NG',  signIn: new Date('2026-03-17T08:10:00'), signOut: null,                          current: true  },
    { id: 's2', device: 'Safari · iPhone 15',  location: 'Abuja, NG',  signIn: new Date('2026-03-15T18:45:00'), signOut: new Date('2026-03-15T20:00:00'), current: false },
