...
@Component({
  selector: 'app-pharm-settings',
  templateUrl: './pharm-settings.component.html',
  styleUrls: ['./pharm-settings.component.scss'],
  animations: [
    trigger('tabContent', [
      transition(':enter', [
...
export class PharmSettingsComponent implements OnInit, OnDestroy {
  ...
  sessions: Session[] = [
    { id: 's1', device: 'Chrome · Windows 11', location: 'Dubai, AE',    signIn: new Date('2026-03-17T08:05:00'), signOut: null,                           current: true  },
    { id: 's2', device: 'Safari · iPhone 14',  location: 'Abu Dhabi, AE',signIn: new Date('2026-03-14T17:30:00'), signOut: new Date('2026-03-14T19:00:00'), current: false },
    { id: 's3', device: 'Firefox · macOS',     location: 'Sharjah, AE',  signIn: new Date('2026-03-10T09:15:00'), signOut: new Date('2026-03-10T10:45:00'), current: false },
  ];
