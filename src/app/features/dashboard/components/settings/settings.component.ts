...
export class SettingsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private wavePoints!: THREE.Points;
  private animId!: number;
  private clock = new THREE.Clock();

  // Profile form — removed (use My Profile page instead)
  // Password / OTP flow
  ...
  // Sessions
  sessions: Session[] = [
    { id: 's1', device: 'Chrome · Windows 11', location: 'Lagos, NG', signIn: new Date('2026-03-16T08:22:00'), signOut: null, current: true },
    { id: 's2', device: 'Safari · iPhone 15', location: 'Abuja, NG', signIn: new Date('2026-03-14T19:05:00'), signOut: new Date('2026-03-14T21:30:00'), current: false },
    { id: 's3', device: 'Firefox · macOS', location: 'London, UK', signIn: new Date('2026-03-10T11:00:00'), signOut: new Date('2026-03-10T12:45:00'), current: false },
  ];
  ...
  private initThree(): void {
    ...
    const ambient = new THREE.AmbientLight(0x0d9488, 0.5);
  ...
  private buildWave(): void {
    ...
    this.wavePoints = new THREE.Points(geo, new THREE.PointsMaterial({
  ...
  private animate(): void {
    ...
    if (this.wavePoints) {
      this.wavePoints.rotation.y = t * 0.012;
      // Animate wave positions
      const pos = (this.wavePoints.geometry.attributes['position'] as THREE.BufferAttribute).array as Float32Array;
  ...
  verifyOtp(): void {
    if (this.otpForm.valid) this.otpStep = 'new';
  }
